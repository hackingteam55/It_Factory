...
class Test(TestCase):
    ...
    FIRST_NAME_INPUT = (By.XPATH, '//input[@id="first-name2"]')
    ...
    def test_check_url(self):
        ...
        self.assertEqual(actual, expected, f'Pagina accesata nu este corecta, am gasit pagina {expected}')
    ...
    def test_form(self):
        ...
        try:
            ...
            self.assertFalse(input_first_name.is_displayed(), 'Mesajul afisat este corect')
            sleep(1)
